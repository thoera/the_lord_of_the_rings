...
movie_1 = pd.read_table(r"datasets\the_lord_of_the_rings" \
                        r"\dialogues_the-fellowship-of-the-ring.txt",
                        sep="|", header=0)

movie_2 = pd.read_table(r"datasets\the_lord_of_the_rings" \
                        r"\dialogues_the-two-towers.txt",
                        sep="|", header=0)

movie_3 = pd.read_table(r"datasets\the_lord_of_the_rings" \
                        r"\dialogues_the-return-of-the-king.txt",
                        sep="|", header=0)
...
# Save the figure.
plt.savefig(r".\scripts\various\the_lord_of_the_rings\plots\talkative.pdf", 
            bbox_inches="tight")
...
# Save the figure.
plt.savefig(r".\scripts\various\the_lord_of_the_rings\plots" \
            r"\talkative_by_movie.pdf", bbox_inches="tight")
